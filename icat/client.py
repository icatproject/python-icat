...
class Client(suds.client.Client):
    ...
    def searchUniqueKey(self, key, objindex=None):
        ...
        the Entity object from the server that created this key.
    ...
    def putData(self, infile, datafile):
        ...
        method will try to :func:`os.fstat` infile and use the last
        modification time from the file system, if available.  If
