...
have_icat_7 = 0 if icat_version < "6.99" else 1
all_rules = 111 + 48*have_icat_5 + 2*have_icat_6_2 + 6*have_icat_7
grp_rules = 51 + 30*have_icat_5 + 2*have_icat_6_2 + 2*have_icat_7
